...
public class JarGenerator {
	public static void generateStubJar(File apk, File output, OutputStream out, Map<String, ClassBreakdown> classes)
		...
		Util.system(new File("tools", "dex2jar"), out,
				Paths.get("tools", "dex2jar", Util.isWindows() ? "d2j-dex2jar.bat" : "d2j-dex2jar.sh").toAbsolutePath()
						.toString(),
				"-nc", "-o", output.getAbsolutePath(), apk.getAbsolutePath());
