...
public class DnDTabbedPane extends JTabbedPane {
	private static final long serialVersionUID = 191772738015183242L;
	...
	class CDropTargetListener implements DropTargetListener {
		...
		private Point glassPt = new Point();
		...
		public void dragOver(final DropTargetDragEvent e) {
			...
			if (!this.glassPt.equals(glassPt)) {
				glassPane.repaint();
			}
			this.glassPt = glassPt;
	...
	class GhostGlassPane extends JPanel {
		private static final long serialVersionUID = 1281823096927883272L;
